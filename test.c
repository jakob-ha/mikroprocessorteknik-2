...
const int BASE_SPEED = 80;      // Base motor speed (0-255)
const int TURN_SPEED = 50;       // Speed during sharp pivot turns
...
void setup() {
  ...
  myServo.write(130);  // Center the ultrasonic sensor straight ahead
    ...
    case LINE_FOLLOWING:
      {
        ...
        Serial.print("Line follow loop start\n");
        /*
...
*/
    ...
    case OBSTACLE_CHECK:
      {
        Serial.print("Obstacle check loop start\n");
...
void bypassObstacle(boolean goLeft) {
  Serial.print("Bypass obstacle start\n");
